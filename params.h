...
namespace NTL {
    ...
    const ZZ a = to_ZZ("1");
    const ZZ d = to_ZZ("2724414110474605931834268501164757645998726878473076809432604223414351675387");
    const ZZ p = to_ZZ("115792089237316195423570985008687907853269984665640564039457584007913129639319");
